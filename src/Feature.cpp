...
// bool svo::Feature::CornerFAST(const cv::Mat& src)
// {
...
bool svo::Feature::GoodFeaturesToTrack(const cv::Mat& src)
{
...
bool svo::Feature::OpticalFlowPyrLK(const cv::Mat& src1, const cv::Mat& src2, svo::Feature& next)
{

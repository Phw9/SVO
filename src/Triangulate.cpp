...
svo::Triangulate::Triangulate(): mworldMapPoints{cv::Mat()}
{
    mworldMapPointsV.clear();
};

bool svo::Triangulate::CalcWorldPoints(const cv::Mat& pose1,
                                        const cv::Mat& pose2,
...
bool svo::Triangulate::ScalingPoints()
{
...
void svo::Triangulate::MatToPoints3f()
{
    cv::Point3f temp;
    for (int i = 0; i < mworldMapPoints.cols; i++) 
    {
